...
public class BookTest {
	...
	public static void main(String[] args) {
		...
		// init sample
		mgr.add(new Book(5675, "나미야잡화점의기적", "히가시노게이고", "Ssafy1", 20000, "베스트셀러", 10));
		mgr.add(new Book(7777, "벚꽃지는 계절에 그대를 그리워하네", "우타노쇼고", "Ssafy1", 18000, "미스테리", 5));
		mgr.add(new Book(4949, "모방범", "미야베미유키", "Ssafy1", 30000, "미스테리/추리", 4));
		mgr.add(new Book(3333, "Y의비극", "엘러리 퀸", "Ssafy1", 15000, "미스테리/추리", 10));

		mgr.add(new Magazine(7893, "월간과학지", "NASA출판사", "NASA", 5000, "7월호", 2020, 7, 30));
		mgr.add(new Magazine(7898, "Time", "time", "time", 6000, "8월호", 2019, 8, 20));
		mgr.add(new Magazine(7899, "Time", "time", "time", 6000, "9월호", 2019, 9, 10));
		...
		while (true) {
			...
			System.out.println("3. 도서재고 추가");
			System.out.println("4. 도서판매");
			...
			case 1:
				...
				if (category == 1) {
					...
					mgr.add(new Book(isbn, title, author, publisher, price, desc, quantity));
					...
					month = sc.nextInt();
					sc.nextLine();
					mgr.add(new Magazine(isbn, title, author, publisher, price, desc, year, month, quantity));
				}
			...
			// start buy
			case 3:
				System.out.println(">도서 재고추가");
				System.out.print(">추가할 도서 ISBN: ");
				isbn = sc.nextInt();
				sc.nextLine();
				System.out.print(">추가할 도서 수량: ");
				quantity = sc.nextInt();
				sc.nextLine();
			...
			case 4:
				...
				System.out.print(">판매할 도서 ISBN: ");
				isbn = sc.nextInt();
				sc.nextLine();
				System.out.print(">판매할 도서 수량: ");
				quantity = sc.nextInt();
				sc.nextLine();
